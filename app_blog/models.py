...
class Categories(models.Model):
    categoryname = models.CharField(max_length=255, verbose_name = "نام دسته بندی")
...
class Post(models.Model):
    ...
    title_tag = models.CharField(max_length=255, default='پست وبلاگ', verbose_name="برچسب عنوان")
